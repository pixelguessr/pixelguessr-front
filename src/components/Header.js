...
export default function Header(){
    ...
    <header className="w-full flex py-1 px-10 items-center justify-between bg-[#14141D]">
      ...
      {
        userName ? <div className="flex items-center text-lg font-semibold leading-6 text-white">{userName}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<Link onClick={()=>setToken('')} to='/login'><ImExit/></Link></div> : <Link to="/login" className="text-lg font-semibold leading-6 text-white">Login <span aria-hidden="true">&rarr;</span></Link>
      }
